...
for (i in conditions) {
  ...
  setwd("~/Documents/EMT_paper_revision/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/ScRNAseqAnalysis/GSE69667_rep1/Cook/")
  #setwd("/home/annawiecek/EMT/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/ScRNAseqAnalysis/GSE69667_rep1/Cook/")
  ...
  #setwd("/home/annawiecek/EMT/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/ScRNAseqAnalysis/GSE69667_rep1/")
  tcga <- read.table("GSE69667_RNASEQ_TPM_rep1.txt", header = TRUE, sep = "\t")
  tcga$ENSG <- NULL
