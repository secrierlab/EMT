...
for (i in conditions) {
  ...
  setwd("~/Documents/EMT_paper_revision/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/ScRNAseqAnalysis/GSE69667_rep2/Cook/")
  #setwd("/home/annawiecek/EMT/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/ScRNAseqAnalysis/GSE69667_rep2/Cook/")
  ...
  #setwd("/home/annawiecek/EMT/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/ScRNAseqAnalysis/GSE69667_rep2/")
  tcga <- read.table("GSE69667_RNASEQ_TPM_rep2.txt", header = TRUE, sep = "\t")
  tcga$ENSG <- NULL
  ...
  input_mock<-merge(tcga,mock_norm2,by.x='gene_symbol',by.y='genes.gene_short_name')
