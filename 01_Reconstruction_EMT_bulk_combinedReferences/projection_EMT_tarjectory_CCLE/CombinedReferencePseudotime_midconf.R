#########################################
#Combined reference pseudotime projection:
#########################################
...
setwd("~/Documents/EMT_paper_revision/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/01_Reconstruction_EMT_bulk/projection_EMT_tarjectory_CCLE/CookReference/data")
...
setwd("~/Documents/EMT_paper_revision/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/01_Reconstruction_EMT_bulk/projection_EMT_tarjectory_CCLE/output_dir/")
load("./mid/CCLE_pseudotime_MCF_mid_conf.RData")

combat_MCF_ccle2_markers_melt2 <- merge(combat_MCF_ccle2_markers_melt2, CCLE_pseudotime_EMT_HMM,
                                        by.x = "CCLE_ID", by.y = "CCLE_ID")

pdf("CCLE_EMT_markers_along_MCFtrajectory_mid_conf.pdf")

p<-ggplot(combat_MCF_ccle2_markers_melt2,
          aes(x=all_pseudotime, y=value, color = hmm_states))+
  geom_point(shape=16,size=2,alpha=0.5)+ylim(0,max(combat_MCF_ccle2_markers_melt2$value))+scale_x_reverse()+
  facet_wrap(.~hgnc_symbol,nrow=3,ncol=3)+ 
  geom_smooth(method = "lm", formula = y ~ poly(x,4),se=TRUE,color="black")+ 
  scale_linetype_manual(values=c("solid"))+theme_classic(base_size=15) + scale_color_manual(values=c('#56B4E9','#EE0C0C', '#E69F00'))
...
pdf("CCLE_EMT_score_along_MCFtrajectory_mid_conf.pdf")
...
pdf("CCLE_EMT_stratified_for_metpotential_mid_conf.pdf")
...
pdf("CCLE_EMT_stratified_for_HMM_mid_conf.pdf")
...
pdf(paste("HMM_CCLE_graph_transition_mock_v2_mid_conf",nstates,"pdf",sep="."))
...
pdf("CCLE_METPOT_stratified_for_HMM_mid_conf.pdf")
...
pdf("CCLE_PENETRANCE_stratified_for_HMM_mid_conf.pdf")
...
pdf("CCLE_PENETRANCE_stratified_for_METPOT_mid_conf.pdf")
...
save(list=c("pseudotimeCCLEderivedMCF","CCLE_pseudotime_EMT","CCLE_pseudotime_EMT_metpot","CCLE_pseudotime_EMT_HMM","CCLE_pseudotime_EMT_metpot_HMM"),file="CCLE_pseudotime_MCF_mid_conf.RData")

library("vcd")
# plot just a subset of the table

pdf("CCLE_on_MCF10_stats_groups_mid_conf.pdf")
...
pdf("CCLE_on_MCF10_Pseudotime_MetPot_midconf.pdf")
...
pdf("CCLE_EMT_METPOT_PENETRANCE_alonpseudotime_v2_midconf.pdf")
...
petalChartGMT(CCLE_pseudotime_EMT_metpot_HMM,var_group="hmm_states",title_string="Met.Potential HMM states",output="CCLE_petalchart_MetPot_for_HMMstates_midconf.pdf")
petalChartGMT_EMT_for_METPOT(CCLE_pseudotime_EMT_metpot_HMM,var_group="status_metpot",title_string="EMT scores Met.Potential",output="CCLE_petalchart_EMTscores_for_MetPot_midconf.pdf")
