...
setwd("~/Documents/EMT_paper_revision/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/01_Reconstruction_EMT_bulk/projection_EMT_tarjectory_CCLE")
load("pseudotime_highconf.RData")
...
pdf("CCLE_EMT_markers_along_MCFtrajectory_high_conf.pdf")
...
pdf("CCLE_EMT_score_along_MCFtrajectory_high_conf.pdf")
...
pdf("CCLE_EMT_stratified_for_metpotential_high_conf.pdf")
...
pdf("CCLE_EMT_stratified_for_HMM_high_conf.pdf")
...
pdf(paste("HMM_CCLE_graph_transition_mock_v2_high_conf",nstates,"pdf",sep="."))
...
pdf("CCLE_METPOT_stratified_for_HMM_high_conf.pdf")
...
pdf("CCLE_PENETRANCE_stratified_for_HMM_high_conf.pdf")
...
pdf("CCLE_PENETRANCE_stratified_for_METPOT_high_conf.pdf")
...
save(list=c("pseudotimeCCLEderivedMCF","CCLE_pseudotime_EMT","CCLE_pseudotime_EMT_metpot","CCLE_pseudotime_EMT_HMM","CCLE_pseudotime_EMT_metpot_HMM"),file="CCLE_pseudotime_MCF_high_conf.RData")

library("vcd")
# plot just a subset of the table

pdf("CCLE_on_MCF10_stats_groups_high_conf.pdf")
...
pdf("CCLE_on_MCF10_Pseudotime_MetPot_highconf.pdf")
...
pdf("CCLE_EMT_METPOT_PENETRANCE_alonpseudotime_v2_highconf.pdf")
...
petalChartGMT(CCLE_pseudotime_EMT_metpot_HMM,var_group="hmm_states",title_string="Met.Potential HMM states",output="CCLE_petalchart_MetPot_for_HMMstates_highconf.pdf")
petalChartGMT_EMT_for_METPOT(CCLE_pseudotime_EMT_metpot_HMM,var_group="status_metpot",title_string="EMT scores Met.Potential",output="CCLE_petalchart_EMTscores_for_MetPot_highconf.pdf")
