...
setwd(paste("/home/annawiecek/EMT/TCGA_PurityScaledAnalysis/MCF10_Cook_averaged/01_Reconstruction_EMT_bulk/projection_EMT_trajectory_TCGA/",i,"/01_Reconstruction_EMT_bulk/",sep = ""))
...
write.table(knn_df_tcga_mock,file=paste("KNN_projection_TCGA_to_",i,"_treated_cells_no_correction_primarytumor_withzeros.txt",sep = ""),row.names=F,quote=F,sep='\t')
